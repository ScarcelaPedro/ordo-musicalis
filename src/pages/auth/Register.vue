  ...
  <GuestLayout>
    <form @submit.prevent="submit" class="space-y-6">
      <div>
        ...
        <TextInput id="input-nome" v-model="name" type="text" class="mt-1" autofocus />
      </div>

      <div>
        <InputLabel value="Email" :required="true" for="input-email" />
        <TextInput id="input-email" v-model="email" type="email" class="mt-1" />
      </div>
      ...
      <div>
        ...
        <TextInput id="input-confirmar-senha" v-model="passwordConfirmation" type="password" class="mt-1" />
      </div>
